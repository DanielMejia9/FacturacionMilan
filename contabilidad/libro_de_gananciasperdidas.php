            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
               ...
               <div class="fondo">
                <div style="background:rgb(245, 245, 245); text-align:left; padding: 5px 0px 0px 0px; height:40px; border-bottom: 1px  #C0C0C0 solid;border-radius: 0px;">
                    <span style="color: #333333; font-weight:bold;font-size:14pt;padding: 0 0 0 10px;">Ganancias y Pérdidas </span>
                </div>
                <br><br>
                <div class="row placeholders"> 
                     ...
                     <div class="col-md-2 col-sm-12 altoBtn">
                        <a type="button" id="Ganancia" class="btn btn-primary" onclick="reporteGananciaG();">Ganancia / G</a>
                    </div> 
                     <div class="col-md-2 col-sm-12 altoBtn">
                        <a type="button" id="Ganancia" class="btn btn-primary" onclick="reporteGananciaD();">Ganancia / D</a>
                    </div> 
                    <div class="col-md-2 col-sm-12 altoBtn">
