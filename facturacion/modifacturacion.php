        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <form name="form_fact" id="form_fact" action="registrar_factura.php" method="post" class="fondo">
                   <div class="row">
                        <?php
                                $codi_clie = $_GET["valor"];
                                $codi_factu = $_GET["codi_factu"];
                                $registro = mysql_query("select * from tb_factura AS A 
                                                            inner join tb_detalle_factura AS C  on A.codi_factu = C.codi_factu
                                                                inner join tb_regi_cli AS B  on A.codi_clie = B.codi_clie 
                                                                    where A.codi_factu ='".$codi_factu."'");
                        ...
                        <div class="col-md-2">
                        Numero de Control: <input type="text" value="000<?php echo $r["codi_factu"]; ?>" name="numero_control" id="numero_control" size="5" class="form-control" />
                        </div>
                        <div class="col-md-2">
                        Numero de Factura: <input type="text" value="<?php echo $r["codi_factu"]; ?>" name="numero_factura" id="numero_factura" size="5"  class="form-control" />
                        </div>
                        <div class="col-md-2">
                   ...
                   <div class="row">
                        <div class="col-md-3">
                            	...
                            	<input type="hidden" id="codigo-cliente" name="codigo-cliente" value="<?php echo $r["codi_clie"];?>" />
                                Nombre del Cliente:  
                               	 <input type="hidden" name="valSelect" id="valSelect"  />
                                 <select name="sele_clie" id="sele_clie" onchange="onSelect(this.value)" value="<?php echo $r["codi_clie"];?>"  class="form-control" > 
        						<?php
        								//Consulta la BD 		
