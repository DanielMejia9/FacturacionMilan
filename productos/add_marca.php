...
include("../start.php");
	  ...
	  if(isset($_POST["anadir"]) and $_POST["anadir"]=="si")
		{
		  $addMarca = $add->AnadirMarca($_POST["descripcion"]);
			exit;
		}
        ...
        <div class="row">
            ...
            <div class="fondo">
                <div style="background:rgb(245, 245, 245); text-align:left; padding: 5px 0px 0px 0px; height:40px; border-bottom: 1px  #C0C0C0 solid;border-radius: 0px;">
                    <span style="color: #333333; font-weight:bold;font-size:14pt;padding: 0 0 0 10px;">Marca</span><br><br>
                </div>
                <br><br>
                <div class="row placeholders">
                  <form name="form_marca" id="form_marca" action="add_marca.php" method="post" autocomplete="off">
                    <div class="row placeholders">
                      <div class="col-md-12">
                        <label>Descripción: </label>
                          <input type="text" name="descripcion" id="descripcion"  maxlength="250" size="50" class="form-control" required autofocus/>
                             </div>
                       </div> 
                       <br />
                       <div class="row placeholders">
