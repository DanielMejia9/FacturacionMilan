        ...
        <div class="row">
            ...
            <div class="fondo">
...

                {
                    ...
                    <td><a href="javascript:void(0);" onclick="window.location='modificar_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo $row[$i]["rif_clie"]?></a></td>
                    ...
                    <td><a href="javascript:void(0);" onclick="window.location='modificar_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo ucwords($row[$i]["ciud_clie"])?></a></td>
                    <td><a href="javascript:void(0);" onclick="window.location='modificar_cliente.php?codi_clie=<?php echo $row[$i]["codi_clie"]?>'"><?php echo ucwords($row[$i]["esta_clie"])?></a></td>
