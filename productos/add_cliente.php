        ...
        <div class="row">
            ...
            <div class="fondo">
                <div style="background:rgb(245, 245, 245); text-align:left; padding: 5px 0px 0px 0px; height:40px; border-bottom: 1px  #C0C0C0 solid;border-radius: 0px;">
                    <span style="color: #333333; font-weight:bold;font-size:14pt;padding: 0 0 0 10px;">Cliente - Datos de la Empresa</span><br><br>
                </div>
                <br><br>
                <div class="row placeholders">
                     <form name="form_clie" id="form_clie" action="add_cliente.php" method="post">
                       ...
                       <div class="row placeholders">
                             ...
                             <div class="col-md-3">
                               <label>RIF:</label>
                               <input type="text" name="rifEmp" id="rifEmp" maxlength="12" size="10" class="form-control"/>
                             </div>
                             <div class="col-md-3">
                               <label>NIT: </label>
                               <input type="text" name="nitEmp" id="nitEmp" maxlength="15" size="10" class="form-control"/>
                             </div>
                             <div class="col-md-3">
                                <label>Fecha: </label>
