...
?>
    ...
    <div id="contenedor_fact">
                ...
                <tr>
                    ...
                    <?php
                        ...
                        Nombre del Cliente:  
                         ...
                         <select name="sele_clie" id="sele_clie" onchange="onSelectP(this.value)" value="<?php echo $row["codi_clie"];?>"  > 
						<?php
								//Consulta la BD 		
        ...
        <div>
            <div id="divBoton">
                    <a href="#" target="_blank"  onclick="guardarPresupuesto();" class="btn">Guardar PDF</a>
