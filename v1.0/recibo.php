...
?>
    ...
    <div id="contenedor_fact">
        ...
        <form name="form_fact" id="form_fact" action="registrar_factura.php" method="post">
            <table border="0" width="100%" height="150" align="center" class="regUser" id="tablaFactura">
                <tr>
                 ...
                 <tr>
                	<td class="c1">
                		Numero de Recibo: <input type="text" name="numero_recibo" id="numero_recibo" size="5" />
                    </td>
                ...
                <tr>
                    ...
                    <?php
                        ...
                        Nombre del Cliente:  
                         ...
                         <select name="sele_clie" id="sele_clie" onchange="onSelectR(this.value)" value="<?php echo $row["codi_clie"];?>"  > 
						<?php
								//Consulta la BD 		
                ...
                <tr>
                    <td class="c3">
                        Direcci&oacute;n: <input type="text" name="dirEmp" value="<?php echo $row["dire_clie"] ?>" id="dirEmp" maxlength="200" size="50" />
        ...
        <div>
            <div id="divBoton">
                    <a href="#" target="_blank"  onclick="guardarRecibo();" class="btn">Guardar PDF</a>
