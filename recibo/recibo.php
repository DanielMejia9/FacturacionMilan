        ...
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <form name="form_fact" id="form_fact" action="registrar_factura.php" method="post" class="fondo">
                   <div class="row">
                        <div class="col-md-6">
                            <h3>Emision de Recibos</h3>
                        </div>
                         <div class="col-md-2 col-md-offset-2">
                            Numero de Recibo: <input type="text" name="numero_recibo" id="numero_recibo" size="5"  class="form-control"/>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                             <?php   							
                                ...
                                Nombre del Cliente:  
                                 ...
                                 <select name="sele_clie" id="sele_clie" onchange="onSelectR(this.value)" value="<?php echo $row["codi_clie"];?>"  class="form-control" > 
        						<?php
        								//Consulta la BD 		
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-md-offset-2">
                            <a href="#" target="_blank"  onclick="guardarRecibo();" class="btn btn-primary">Guardar PDF</a>
                        </div>
                        <div class="col-md-3">
